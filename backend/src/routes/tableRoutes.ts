...
import { createTable, getTables, closeTable, editTableDetails, joinTable, leaveTable, getTableDetails } from '../controllers/tableController';
...
router.get('/:tableCode', authenticateToken, getTableDetails);
