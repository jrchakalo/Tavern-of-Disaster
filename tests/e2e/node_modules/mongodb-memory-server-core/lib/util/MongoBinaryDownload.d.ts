...
export declare class MongoBinaryDownload {
     ...
     */
    httpDownload(url: URL, httpOptions: RequestOptions, downloadLocation: string, tempDownloadLocation: string, maxRetries?: number, baseDelay?: number, timeout?: number): Promise<string>;
    /**
