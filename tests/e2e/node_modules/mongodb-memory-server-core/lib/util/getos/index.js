...
exports.tryReleaseFile = exports.parseOS = exports.parseLSB = exports.isValidOs = exports.getOS = exports.isLinuxOS = exports.UNKNOWN = void 0;
...
async function tryReleaseFile(path, parser) {
    try {
        ...
        if ((0, utils_1.errorWithCode)(err) && !['ENOENT', 'EACCES'].includes(err.code)) {
            throw err;
        }
